...
export const config = {
  ...
  artifacts: {
    'decision-tree': {
      ...
      summary:
        'An interactive tree visualization tool built with React, Redux, and D3.js.',
      links: [
        {
          label: 'Website',
      ...
      images: [
        ...
        },
        {
          ...
          caption:
            'Freely create and edit nodes to fit your needs. Mark as complete or delete, or MOVE nodes around the tree.',
        },
        {
          src: 'assets/decision-tree/dt-3.jpg',
          alt: 'Edit A Node dialog over a dimmed tree',
          caption:
            'Collapse nodes into easy-to-view subtrees. The more subnodes, the bigger the collapsed node will be.',
        },
        {
          src: 'assets/decision-tree/dt-4.jpg',
          alt: 'Create A Node dialog above a Redux action log in devtools',
          caption:
            'All interactions are redux actions, with a pre-state, dispatched action, and post-state.',
        },
      ],
    },
    experealization: {
      ...
      summary:
        'A travel and work blog chronicling stories and photography across seven countries in Southeast Asia.',
      links: [
        {
          label: 'Website',
      ...
      images: [
        {
          ...
          alt: 'Travel Blog',
          caption:
            'Travel and work blog from my nearly two years in Southeast Asia.',
        },
        {
          src: 'assets/experealization/exp2.jpg',
          alt: 'Blog post with a grid of Myanmar street and temple photos',
          caption:
            'Designed using Wordpress, the blog chronicles stories and photography across seven countries.',
        },
        {
    ...
    gram: {
      ...
      summary:
        'A collaborative whiteboarding and chat tool built with Node/Express and Socket.io.',
      links: [
        {
          label: 'GitHub',
      ...
      images: [
        {
          ...
          caption:
            'Gram is a real-time whiteboarding and chatting tool. When connected to the server, a user can contribute to both the whiteboarding and chat, and all users are updated in real-time. This app was built over the course of one-and-a-half workdays as part of a coding challenge.',
        },
        {
          src: 'assets/gram/gram2.jpg',
          alt: 'The gram whiteboard and chat in a window over a desktop',
          caption:
            'To achieve this cross-browser and cross-device functionality, Gram uses Node/Express and Socket.io on the back-end, and HTML5 Canvas, jQuery, and Socket.io on the front-end.',
        },
      ],
    },
    immedia: {
      ...
      summary:
        "A news, social media, and wiki aggregator that combines real-time updates with Wikipedia's depth.",
      links: [
        {
          label: 'GitHub',
      ...
      images: [
        ...
        },
        {
          ...
          caption:
            'Gorgeous, interactive infographics and embedded content from the likes of Twitter and YouTube using D3.js & React.',
        },
        {
          src: 'assets/immedia/immedia3.jpg',
          alt: 'A Wikipedia article with a Recent Media timeline added',
          caption:
            "A Chrome extension that embeds on all Wikipedia articles, blending Wikipedia's depth with Immedia's recency.",
        },
      ],
    },
    trifecta: {
      ...
      summary:
        'A secure network consisting of a composable backend, frontend builder, and workflow engine.',
      links: [],
      images: [
        {
        ...
        },
        {
          ...
          caption:
            'In this sample app created with Trifecta, a user can create a new task after login. The UI is built via the drag-and-drop UI builder. A Task is an entity created with the backend builder, with associated RESTful API endpoints.',
        },
        {
          src: 'assets/trifecta/workflow.jpg',
          alt: 'Five-step flow: webhook, OpenAI, two HTTP calls, Slack',
          caption:
            'Once the task is created, a webhook triggers an automated workflow. In this sample, OpenAI will suggest steps to complete the new task, update the task, and send those updates to Slack.',
        },
        {
          src: 'assets/trifecta/task-comment.jpg',
          alt: 'Task detail with numbered AI suggestions in the comments',
          caption:
            'The task is updated with the generated suggestions within seconds (with relevant links).',
        },
        {
        ...
        },
        {
          ...
          caption:
            'Creating a secure webhook triggers automated workflows, like AI generated task suggestions.',
        },
      ],
    },
    'figma-wireframes': {
      ...
      summary:
        'Part of a project to develop a loyalty program for an e-commerce site.',
      links: [],
      images: [
        {
    ...
    'scheduled-reports': {
      ...
      summary:
        'An architectural deep dive into delivering scheduled reports of sensitive data to clients.',
      links: [
        {
          label: 'View full PDF',
      ...
      images: [
        {
          ...
          caption:
            'I made this slide deck for an interview, highlighting architectural decisions to deliver scheduled reports of sensitive data to clients while working for an e-commerce company.',
        },
      ],
    },
    'sanity-check': {
      ...
      summary:
        'Enter your message and the context behind it (it could be a URL, an email, or document) and get a sanity check from AI.',
      links: [
        {
          label: 'Website',
      ...
      images: [
        {
          ...
          alt: 'Sanity Check',
          caption:
            'Simply enter your message and the context behind it (it could be a URL, an email, or document) and get a sanity check from AI. It will check for sentiment, tone, correctness, and of course, grammar and typos.',
        },
      ],
    },
  },
